...
public class CompteEditorPaneController implements Initializable {
	...
	public CompteCourant displayDialog(Client client, CompteCourant cpte, EditionMode mode) {
		...
		case CREATION:
			...
			this.lblSolde.setText("Solde (premier d√©p√¥t)");
			this.btnOk.setText("Ajouter");
			this.btnCancel.setText("Annuler");
			break;
		case MODIFICATION:
			AlertUtilities.showAlert(this.primaryStage, "Non impl√©ment√©", "Modif de compte n'est pas impl√©ment√©", null,
					AlertType.ERROR);
			return null;
		// break;
		case SUPPRESSION:
		...
		// Param√©trages sp√©cifiques pour les chefs d'agences
	...
	/*
	 * VÈrifie le dÈcouvert autorisÈ d'un compte
	 */
	...
	/*
	 * Permet de fermer la fenÍtre si un compte est inexistant
	 */
	@FXML
	...
	/*
	 * Permet d'ajouter un compte ‡ la liste s'il a ÈtÈ crÈÈ, modifiÈ, ou supprimÈ
	 */
	@FXML
	...
	/*
	 * VÈrifie que la saisie des modifications soit valide
	 */
