...
public class LoginDialog {
	...
	/*
	 * Permet d'afficher une boite de dialogue le login
	 */
	...
	/*
	 * Permet de trouver un employé à l'aide de ses identifiants
	 * @param login : l'identifiant de  l'employé
	 * @param password : le mot de passe de l'employé
	 * @return l'employé possédant l'identifiant et le mot de passe
	 */
