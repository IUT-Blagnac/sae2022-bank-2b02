...
public class OperationsManagement {
	...
	/*
	 * Permet de cr�er une boite de dialogue li�e aux op�rations de management
	 */
	 ...
	 * @return l'op�ration en question
	 */
	 ...
	 * @return une PairsOfValue contenant le compte courant et une ArrayList d'op�rations 
	 */
