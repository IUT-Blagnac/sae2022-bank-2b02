...
image::https://github.com/IUT-Blagnac/sae2022-bank-2b02/blob/main/documentation/images_doc_tec_v2/diagramme_ucv2.svg[diagramme_ucv2]

=== Diagramme de classe des données global

image::https://github.com/IUT-Blagnac/sae2022-bank-2b02/blob/main/documentation/images_doc_tec_v2/dc-initialv2.svg[diagramme_classesv2]
...
Dans le use case, un cas s'utilisation nommé "Générer un relevé mensuel d'un compte en PDF" a été créé. Il a été relié à l'acteur "Guichetier".
...
Dans le use case, un cas s'utilisation nommé "Gérer les prélèvements automatiques" a été créé. Il a été relié à l'acteur "Guichetier".
...
Dans le use case, un cas s'utilisation nommé "Effectuer un débit excpetionnel" a été créé. Il a été relié à l'acteur "Chef d'agence".
...
Dans le use case, un cas s'utilisation nommé "Simuler un emprunt" a été créé. Il a été relié à l'acteur "Chef d'agence".
...
Dans le use case, un cas s'utilisation nommé "Simuler une assurance d'emprunt" a été créé. Il a été relié à l'acteur "Chef d'agence".
